...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '18762306464'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  'LOL',
  packname:  process.env.PACK_NAME || 'LOL',
  
  botname:   process.env.BOT_NAME === undefined ? "LOL-MD" : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'SHAUN-𝙈𝘿' : process.env.OWNER_NAME,  
